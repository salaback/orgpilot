    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
      ...
      <Card>
        ...
        <CardContent>
          {incompleteTasks.length > 0 && (
            <div className="mb-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="includePreviousTasks"
                  checked={includePreviousTasks}
                  onCheckedChange={handleIncludePreviousTasks}
                />
          ...
          {data.tasks.length === 0 ? (
            <p className="text-center text-gray-500 py-4">No action items yet. Add some using the button above.</p>
          ) : (
            <div className="space-y-4">
              {data.tasks.map((task, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-[1fr,auto,auto,auto] gap-4 items-start border-b pb-4">
                  <div className="space-y-2">
