...
const todaysDate = format(today, 'MMMM d, yyyy');
              ...
              {meetings && meetings.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <Link href="/meetings/create" className="mt-2">
                    <Button variant="outline" size="sm">Schedule a meeting</Button>
                  </Link>
                </div>
              )}
            </CardContent>
            ...
            <CardContent>
              {actionItems && actionItems.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-4 text-center">
                  <ListTodoIcon className="h-8 w-8 mb-2 text-muted-foreground" />
          ...
          <Card>
            ...
            <CardContent>
              {goals && goals.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-4 text-center">
                  <TargetIcon className="h-8 w-8 mb-2 text-muted-foreground" />
          ...
          <Card>
            ...
            <CardContent>
              {initiatives && initiatives.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-4 text-center">
                  <StarIcon className="h-8 w-8 mb-2 text-muted-foreground" />
