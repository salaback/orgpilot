...
export default function TasksPage({ tasks, initiatives, employees }: TasksPageProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="h-full w-full">{viewMode === 'list' ? <TaskManagement {...taskProps} /> : <TaskSplitView {...taskProps} />}</div>
        </AppLayout>
    );
}
