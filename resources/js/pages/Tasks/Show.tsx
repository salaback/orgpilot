...
import { ArrowLeft, Calendar, CheckCircle2, Clock, Edit, Tag as TagIcon, User } from 'lucide-react';
...
const Show: React.FC<ShowProps> = ({ task, notes }) => {
    ...
    const updateProgress = (newProgress: number) => {
        router.patch(
            route('tasks.update-progress', task.id),
            {
            ...
            <div className="w-full px-4 py-6 sm:px-6 lg:px-8">
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <div className="mb-2 flex items-center">
                            ...
                            <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl dark:text-gray-100">{task.title}</h1>
                        </div>
                    ...
                    <Button
                        variant="outline"
                        onClick={() => {
                            /* TODO: Implement onEdit handler in parent */
                        }}
                    >
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <div className="lg:col-span-2">
                        ...
                        <Card className="mb-6">
                            <div className="p-6">
                                <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-gray-100">Progress</h2>
                                <div className="mb-4">
                                ...
                                <div className="mt-4 flex flex-wrap gap-2">
                                    <Button size="sm" variant="outline" onClick={() => updateProgress(0)}>
                                        0%
                                    </Button>
                                    <Button size="sm" variant="outline" onClick={() => updateProgress(25)}>
                                        25%
                                    </Button>
                                    <Button size="sm" variant="outline" onClick={() => updateProgress(50)}>
                                        50%
                                    </Button>
                                    <Button size="sm" variant="outline" onClick={() => updateProgress(75)}>
                                        75%
                                    </Button>
                                    <Button size="sm" variant="outline" onClick={() => updateProgress(100)}>
                                        100%
                                    </Button>
                                </div>
                            </div>
                        ...
                        <NotesSection notes={notes} entityType="Task" entityId={task.id} />
                    </div>

                    <div className="lg:col-span-1">
                        <Card className="mb-6">
                            <div className="p-6">
                                <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-gray-100">Details</h2>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {task.initiative && (
                                        <div className="flex items-start">
                                            <CheckCircle2 className="mt-0.5 mr-3 h-5 w-5 text-gray-500" />
                                            <div>
                                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Initiative</p>
                                                <Link href={route('initiative.show', task.initiative.id)} className="text-blue-600 hover:underline">
                                    ...
                                    {task.tags && task.tags.length > 0 && (
                                        <div className="flex items-start">
                                            <TagIcon className="mt-0.5 mr-3 h-5 w-5 text-gray-500" />
                                            <div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            {task.created_at !== task.updated_at && (
                                                <p className="mt-1 text-xs text-gray-500">Updated {formatDateTime(task.updated_at)}</p>
                                            )}
                                        </div>
                                    </div>
                                </div>
