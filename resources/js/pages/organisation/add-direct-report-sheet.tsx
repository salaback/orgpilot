        ...
        <SheetPanel
            ...
            footer={
                <div className="flex w-full justify-end space-x-2">
                    ...
                    <Button type="submit" disabled={processing} form="add-direct-report-form">
                        Add Direct Report
                    </Button>
                </div>
            }
            ...
            <form id="add-direct-report-form" onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-5">
                    ...
                    <div>
                        ...
                        <Select value={data.node_type} onValueChange={(value) => setData('node_type', value)}>
                        ...
                        {errors.node_type && <p className="mt-1 text-sm text-red-500">{errors.node_type}</p>}
                    </div>
                </div>
            </form>
        </SheetPanel>
