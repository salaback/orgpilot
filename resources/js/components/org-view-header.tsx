        ...
        <React.Fragment>
            ...
            {focusedEmployee.manager_id && focusedEmployee.id !== rootEmployee.id && (
                <span className="ml-1 text-sm text-muted-foreground">
                    • Reports to:{' '}
                    <span className="cursor-pointer font-medium hover:text-primary" onClick={onNavigateUp}>
            ...
            {(focusedEmployee || employeeHierarchy.length > 0) && (
                <>
                    ...
                    {focusedEmployee && focusedEmployee.id !== rootEmployee.id && (
                        <Button variant="outline" size="sm" onClick={onNavigateUp} className="flex items-center gap-1">
                            <ChevronUp className="h-4 w-4" />
                            <span>Up One Level</span>
                        </Button>
                    )}
                    <Button variant="outline" size="sm" onClick={onNavigateToRoot} className="flex items-center gap-1">
